 ...
 * from the one before it. The reading itself is
 * `boxesChangedBetweenScans` — all this adds is which two scans to compare.
 */
export function boxesChangedInLastScan(): ReadonlyArray<Rect> {
  return boxesChangedBetweenScans(obstacleRectsBeforeScan, obstacleRectsAtScan)
}
