<img src="docs/media/hero.svg" alt="ANNOCON — โน้ตและเส้นเชื่อมที่อยู่ในไฟล์ Figma จริง" width="880">
...
| **ป้ายกำกับที่คลิกแก้ได้**<br>คลิกที่ป้ายบนเส้นแล้วพิมพ์ได้เลย ไม่ต้องหาตัวเส้นก่อน | **ดัดเส้นเองได้ แล้วยังตาม layer**<br>แก้รูปทรงด้วยเครื่องมือ vector ปลั๊กอินไม่คำนวณทับ แต่ยังเลื่อนตามจอให้อยู่ |
| <img src="docs/media/style.svg" width="300"> | <img src="docs/media/maze.svg" width="300"> |
| **ปรับแต่งได้ครบ**<br>สี ความหนา opacity รูปแบบเส้น หัว-ท้ายเส้น ทิศทางออก-เข้า | **หาทางแม้บอร์ดแน่นมาก**<br>เจอกำแพงจอที่มีช่องว่างเดียว ก็ยังหาทางลอดได้ ไม่ใช่แค่เดาทางที่ดีที่สุด |
