...
- **แก้ข้อความได้ทั้งบน canvas และในหน้าต่างปลั๊กอิน** — ดับเบิลคลิกที่การ์ดพิมพ์ได้เลย
  หรือคลิกการ์ดแล้วแก้ในปลั๊กอินก็ได้ ทั้งสองทางเขียนที่เดียวกัน
- **เลือกขนาดการ์ดได้ 3 แบบ** (Small / Medium / Large) หรือลากขอบการ์ดปรับความกว้างเอง
  ข้อความจะไหลตามความกว้างใหม่ทันที
...
- **เส้นแบบหักมุมจะอ้อมเฟรมอื่นที่ขวางทางให้เอง** และอ้อมใหม่ทันทีเมื่อมีเฟรมถูกลากเข้ามาขวาง
  หรือลากออกไป — กำหนดทิศทางการอ้อมเองได้ด้วยช่อง **Go around**
- ใส่ป้ายกำกับบนเส้นได้ คลิกที่ป้ายแล้วพิมพ์แก้ได้เลยบน canvas
