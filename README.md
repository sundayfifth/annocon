...
เช็คว่าไปที่ถูกเมนูไหม ต้องเป็น **Plugins → Development → ANNOCON** (ไม่ใช่ Plugins ธรรมดา
ที่โชว์ปลั๊กอินจาก Figma Community) ถ้ายังไม่เจอ แปลว่ายังไม่ได้ import — ย้อนกลับไปทำตาม
ขั้นตอน "วิธีติดตั้ง" ด้านบนก่อน

**จะลบปลั๊กอินออกยังไง**
ไปที่ **Plugins → Development → Manage plugins…** แล้วลบ ANNOCON ออกจากลิสต์ จากนั้นจะลบ
โฟลเดอร์ที่แตกไฟล์ไว้ในเครื่องทิ้งด้วยก็ได้ (ไม่จำเป็นต้องเก็บไว้แล้ว)

**ปลั๊กอินใช้ได้กับไฟล์ FigJam ไหม**
ไม่ได้ ตอนนี้รองรับเฉพาะไฟล์ Design เท่านั้น
