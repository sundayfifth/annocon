...
>
> **version:** bump เป็น **0.6.0** พร้อม B6 — เลื่อนมาจาก PR #5 โดยตั้งใจ เพื่อให้งานทั้งรอบ
> เป็น version เดียว ตามกฎของ T7 ที่ว่า bump ทุกครั้งที่ merge งานที่เปลี่ยนพฤติกรรม
